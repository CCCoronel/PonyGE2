...
class SANDLFitness(base_ff):
    ...
    def evaluate(self, individual: Individual, **kwargs):
        """
        Avalia um único fenótipo SANDL.
        """
        try:
            phenotype = individual.phenotype
            # print(f"INFO (Fitness): Avaliando fenótipo: {individual}...")  # Exibe os primeiros 50 caracteres do fenótipo
            # 1. Validação
            ...
            print(f"INFO (Fitness): Avaliação E Criação do Indivídue {individual} concluída com sucesso.")
