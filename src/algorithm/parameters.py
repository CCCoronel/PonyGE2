...
from generatorSandl.SANDLFitness import SANDLFitness
...
params = {
    # -- Funções de Loop e Passo do PonyGE2 --
    'SEARCH_LOOP': 'search_loop',
    'STEP': 'step',

    # -- Parâmetros Evolutivos Principais --
    'POPULATION_SIZE': 50,
    'GENERATIONS': 20,
    'ELITE_SIZE': 1,                      # Adicionado: É uma boa prática manter o melhor

    # -- Configuração da Gramática e Fitness --
    'GRAMMAR_FILE': "generatorSandl/sandl-gen.bnf", # ATUALIZADO
    'FITNESS_FUNCTION': SANDLFitness(),       # ATUALIZADO para usar sua classe
    'MAXIMIZE_FITNESS': False,                      # Adicionado: CRUCIAL para RMSE

    # -- Configuração do Problema e Dataset --
    'DATASET_TRAIN': "RenewableEnergy/train.csv",   # ATUALIZADO
    'DATASET_TEST': "RenewableEnergy/test.csv",     # ATUALIZADO
    'DATASET_DELIMITER': ',',                       # Adicionado: Comum para arquivos .csv

    # -- Métrica de Erro (para referência, mas o fitness é calculado na sua classe) --
    'ERROR_METRIC': 'rmse',                         # ATUALIZADO

    # -- Parâmetros Customizados para sua Função de Fitness --
    'FITNESS_EPOCHS': 5,
    'BATCH_SIZE': 32,

    # -- Limites de Tamanho e Estrutura --
    'MAX_TREE_DEPTH': 90,                           # ATUALIZADO
    'MAX_TREE_NODES': 1000,                         # ATUALIZADO
    'CODON_SIZE': 32,                               # ATUALIZADO
    'MAX_GENOME_LENGTH': 100,                       # ATUALIZADO
    'MAX_WRAPS': 1,                                 # ATUALIZADO

    # -- Inicialização da População --
    'INITIALISATION': "operators.initialisation.rhh", # ATUALIZADO (Ramped Half-and-Half)
    'INIT_GENOME_LENGTH': 100,                      # ATUALIZADO
    'MAX_INIT_TREE_DEPTH': 10,                      # ATUALIZADO
    'MIN_INIT_TREE_DEPTH': 2,                       # Adicionado: Evita indivíduos muito pequenos

    # -- Seleção --
    'SELECTION': "operators.selection.tournament",  # ATUALIZADO
    'TOURNAMENT_SIZE': 2,                           # ATUALIZADO
    'SELECTION_PROPORTION': 0.75,                   # ATUALIZADO

    # -- Crossover --
    'CROSSOVER': "operators.crossover.subtree",     # ATUALIZADO
    'CROSSOVER_PROBABILITY': 0.75,                  # ATUALIZADO
    'NO_CROSSOVER_INVALIDS': True,                  # ATUALIZADO

    # -- Mutação --
    'MUTATION': "operators.mutation.subtree",       # ATUALIZADO
    'MUTATION_PROBABILITY': None,                   # ATUALIZADO (Padrão: 1/tamanho_do_genoma)
    'MUTATION_EVENTS': 1,                           # ATUALIZADO
    'NO_MUTATION_INVALIDS': True,                   # ATUALIZADO

    # -- Substituição --
    'REPLACEMENT': "operators.replacement.steady_state", # ATUALIZADO

    # -- Debug e Saída --
    'DEBUG': False,                                 # ATUALIZADO
    'VERBOSE': True,                                # ATUALIZADO
    'SILENT': False,

    # -- Salvamento de Resultados --
    'SAVE_ALL': True,                               # ATUALIZADO
    'SAVE_PLOTS': True,

    # -- Cache para Eficiência --
    'CACHE': True,                                  # ATUALIZADO
    'LOOKUP_FITNESS': True,                         # ATUALIZADO
    
    # -- Semente para Reprodutibilidade --
    'RANDOM_SEED': 42,                              # Adicionado: Use um número fixo para testes

    # ##########################################################################
    # As chaves abaixo são mantidas com seus valores padrão, pois não foram
    # especificadas para alteração.
    # ##########################################################################
